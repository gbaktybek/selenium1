...
public class LearnJavascriptExecution extends CommonMethods{
    ...
    public void learnJsExecutor() throws InterruptedException {
        ...
        //here we are calling the .executeScript() method and passing JS snippet (script) in order to scroll down by 500px
        ...
        //here we are usng different script and passing a variable WebElement as an argument to the JS script
